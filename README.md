# [full stack proxy nginx SolidInvoice for everyone with docker compose](https://github.com/damalis/full-stack-proxy-nginx-solidinvoice-for-everyone-with-docker-compose)

If You want to build a reverse proxy website with SolidInvoice at short time;

#### Full stack Proxy Nginx SolidInvoice:
<p align="left"> <a href="https://solidinvoice.co/" target="_blank" rel="noreferrer"> <img src="https://avatars.githubusercontent.com/u/25333451?s=200&v=4" alt="SolidInvoice" height="40" width="40"/> </a>&nbsp;&nbsp;&nbsp; 
...
```
git clone https://github.com/damalis/full-stack-proxy-nginx-solidinvoice-for-everyone-with-docker-compose.git
```

Open a terminal and `cd` to the folder in which `docker-compose.yml` is saved and run:

```
cd full-stack-proxy-nginx-solidinvoice-for-everyone-with-docker-compose
chmod +x install.sh
./install.sh
```
...
The containers are now built and running. You should be able to access the SolidInvoice installation with the configured IP in the browser address. `https://example.com`.
...
add and/or remove solidinvoice site folders and files with any ftp client program in ```./solidinvoice``` folder.
